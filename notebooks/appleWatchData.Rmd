...
```
Here we can see the average and median amount of data recordings fall around 700 instances per day. 
## Calendar Heatmap
...
```
The average for each month still gravitates around 1 minute. Now let's try grouping by weekday and month. This time I created a visual since the output would be too large to read easily.  
