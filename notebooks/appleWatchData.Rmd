...
When utilizing functions in the `here` package, we will use the notation below:
...
This will help showcase the structure of the data frame and is a general good practice to help other users become familiar with the data frame.
